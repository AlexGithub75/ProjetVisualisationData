export default function renderPieChart(svg, data) {
    ...
    const color = d3.scaleOrdinal()
        ...
        .range(['#1E90FF', '#FFA500', '#32CD32']); // Couleurs : Bleu (DDoS), Orange (Malware), Vert (Intrusion)
